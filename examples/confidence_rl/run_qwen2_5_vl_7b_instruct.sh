...
VALIDATION_DIR=${VALIDATION_DIR:-$(join_path "$PROJECT_DIR" "logs/val_dumps/qwen2.5vl7b-${ALGO}-${EXP}")}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-$(join_path "$PROJECT_DIR" "checkpoints/qwen2.5vl7b-${ALGO}-${EXP}")}
